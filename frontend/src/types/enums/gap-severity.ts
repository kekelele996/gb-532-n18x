...
export const GAP_SCHEDULABLE_STATES: readonly GapState[] = ['detected','reviewed']
export const GAP_SEVERITY_RANK: Record<GapSeverity,number> = { critical: 0, major: 1, minor: 2 }
