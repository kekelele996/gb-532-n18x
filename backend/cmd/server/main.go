...
func main() {
	...
	resurveyRepository := repository.NewResurveyTaskRepository(db)
	...
	resurveyService := service.NewResurveyTaskService(resurveyRepository, coverageRepository, auditService)
	...
	handlers := router.Handlers{
		...
		Coverage: handler.NewCoverageGapHandler(coverageService), Resurvey: handler.NewResurveyTaskHandler(resurveyService),
