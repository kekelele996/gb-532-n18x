...
func OpenDatabase(config Config) (*gorm.DB, error) {
	...
	if config.AutoMigrate {
		if err := db.AutoMigrate(&model.User{}, &model.SurveyArea{}, &model.TransectPlan{}, &model.SonarRun{}, &model.CoverageGap{}, &model.ResurveyTaskSheet{}, &model.AuditEvent{}); err != nil {
