...
type Handlers struct {
	...
	Resurvey *handler.ResurveyTaskHandler
...
func New(log *slog.Logger, auth *service.AuthService, handlers Handlers) *gin.Engine {
	...
	protected.PUT("/areas/:id", middleware.RBAC(constants.RoleAdmin, constants.RoleSurveyPlanner), handlers.Area.Update)
	...
	protected.POST("/coverage-gaps/resurvey-schedule", coverageLimit.Middleware("resurvey-schedule"), middleware.RBAC(constants.RoleAdmin, constants.RoleReviewer), handlers.Resurvey.Schedule)
